  ...
  private static void sendSimpleReport(String sitename, StatusReportItem statusReportItem,
    ...
    try {
      if (!ProjectInfo.INSTANCE.getProjectName().equalsIgnoreCase("samply")
          && !statusReportItem.getParameterName().equals("host")
          || ProjectInfo.INSTANCE.getProjectName().equalsIgnoreCase("dktk")
          || ProjectInfo.INSTANCE.getProjectName().equalsIgnoreCase("samply")
          && !statusReportItem.getParameterName().equals("host")) {
        HttpPost httpPost;
